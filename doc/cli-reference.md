...
Truthy values (trimmed, case-insensitive):
...
- `doc/quick-reference.md` for rapid lookup
- `doc/operational-spec.md` for full semantics
- `doc/troubleshooting.md` for failure diagnosis
